...
CREATE TABLE `sync_data`  (
                              ...
                              `table_id` bigint NULL DEFAULT NULL COMMENT '表id',
                              `db_id` bigint NULL DEFAULT NULL COMMENT '数据库id',
                              `data_info` text CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL COMMENT '初始化insert语句',
                              ...
                              `col_value` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NULL DEFAULT NULL COMMENT '列值',
                              PRIMARY KEY (`id`) USING BTREE
...
CREATE TABLE `sync_table`  (
                               ...
                               `table_info` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '建表语句',
                               `index_id` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '索引',
                               `fk_id` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL COMMENT '外键',
                               `remarks` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '备注',
                               `type` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '表类型，table、view',
                               `pk` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '主键',
                               `create_time` datetime NOT NULL COMMENT '创建时间',
                               `update_time` datetime NULL DEFAULT NULL COMMENT '修改时间',
                               PRIMARY KEY (`id`) USING BTREE,
